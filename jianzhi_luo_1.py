...
with g.as_default():
    ...
    with tf.name_scope("conv1"):
        w_cov1 = set_variable(wcov1, w1=0.00,name = 'w')
        b_cov1 = set_variable(bcov1, w1=0.00,name = 'b')
        h_cov1 = tf.nn.relu(conv2d(x_images, w_cov1, name= 'conv1') + b_cov1,name = 'relu')
    with tf.name_scope("con1_incep3a1"):
        w1 = set_variable(wcov13a1, w1=0.00,name = 'w')
        b1 = set_variable(bcov13a1, w1=0.00,name = 'b')
        h1= tf.nn.relu(conv2d(h_cov1, w1, name= 'conv1') + b1,name = 'relu')
    with tf.name_scope("con2_incep3a1"):
        w2 = set_variable(wcov23a1, w1=0.00, name='w')
        b2 = set_variable(bcov23a1, w1=0.00, name='b')
        h2 = tf.nn.relu(conv2d_same(h1, w2, name='conv1') + b2, name='relu')

    with tf.name_scope("con1_incep3a2"):
        w1_1 = set_variable(wcov13a2, w1=0.00,name = 'w')
        b1_1 = set_variable(bcov13a2, w1=0.00,name = 'b')
        h1_1= tf.nn.relu(conv2d(h_cov1, w1_1, name= 'conv1') + b1_1,name = 'relu')
    with tf.name_scope("con2_incep3a2"):
        w2_1 = set_variable(wcov23a2, w1=0.00,name = 'w')
        b2_1 = set_variable(bcov23a2, w1=0.00,name = 'b')
        h2_1 = tf.nn.relu(conv2d_same(h1_1, w2_1, name='conv1_1') + b2_1, name='relu')

    with tf.name_scope("con1_incep3a3"):
        w1_2 = set_variable(wcov13a3, w1=0.00,name = 'w')
        b1_2 = set_variable(bcov13a3, w1=0.00,name = 'b')
        h2_2 = tf.nn.relu(conv2d(h_cov1, w1_2, name='conv1') + b1_2, name='relu')

    with tf.name_scope("max1_incep3a4"):
        h1_3= max_pool_2x2_same(h_cov1,name = 'maxpooling_conv2')
    with tf.name_scope("con2_incep3a4"):
        w2_3 = set_variable(wcov23a4, w1=0.00,name = 'w')
        b2_3 = set_variable(bcov23a4, w1=0.00,name = 'b')
        h2_3 = tf.nn.relu(conv2d_same(h1_3, w2_3, name='conv1_1') + b2_3, name='relu')
    ...
    with tf.name_scope("conv2"):
        ...
        h_cov2 = tf.nn.relu(conv2d_same(incep, w_cov2, name = 'conv2') + b_cov2,name = 'relu_conv2')
    ...
    with tf.name_scope("fc1"):
        h_pool2_reshape = tf.reshape(h_pool3, [-1, 7*7*len(out2)], name='cnn_fc_convert')
