...
def evaluate_pictures(n_epochs=20,batch_size=50):
    ...
    with tf.name_scope("conv1"):
        w_cov1 = weight_variable([1, 1, 1, 6], 'w')
        variable_summaries(w_cov1)
    ...
    with tf.name_scope("con1_incep3a3"):
        w1_2 = weight_variable([1, 1, 6, 12], 'w')
    ...
    with tf.name_scope("con2_incep3a4"):
        w2_3 = weight_variable([1, 1, 6, 8], 'w')
    ...
    with tf.name_scope("conv2"):
        w_cov2 = weight_variable([3, 3, 32, 16],name = 'w_conv2')
    ...
    with tf.name_scope("conv3"):
        w_cov3 = weight_variable([3, 3, 16, 8],name = 'w_conv3')
